...
const LockSync01: React.FC<IconProps> = ({ 
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M19.5433 10.5L22 11C21.497 5.94668 17.2229 2 12.0247 2C6.48824 2 2 6.47715 2 12C2 17.5228 6.48824 22 12.0247 22C16.1355 22 19.6684 19.5318 21.2153 16" stroke="#1B1C1B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
